...
namespace UwpNetworkingEssentials.StreamSockets
{
    ...
    public class StreamSocketConnection
        : ConnectionBase<StreamSocketRequest, StreamSocketResponse, StreamSocketDisconnectEventArgs>
    {
        ...
        private readonly Dictionary<int, TaskCompletionSource<StreamSocketResponse>> _pendingRequests =
            new Dictionary<int, TaskCompletionSource<StreamSocketResponse>>();
        ...
        protected override async Task<StreamSocketResponse> SendMessageCoreAsync(object message)
        {
        ...
        {
            _disconnected.OnNext(new StreamSocketDisconnectEventArgs(this, _disconnectReason));
            _reader.Dispose();
            _writer.Dispose();
            _socket.Dispose();
        }
