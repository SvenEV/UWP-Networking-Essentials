...
namespace UwpNetworkingEssentials.AppServices
{
    ...
    {
        internal static async Task<ASResponse> SendMessageAsync(this AppServiceConnection connection, object message, IObjectSerializer serializer)
        {
        ...
        internal static async Task<ASResponseStatus> SendResponseAsync(this AppServiceRequest request, object message, IObjectSerializer serializer)
        {
            var valueSet = serializer.SerializeToValueSet(message);
